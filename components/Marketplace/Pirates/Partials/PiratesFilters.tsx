...
const URL = `${process.env.NEXT_PUBLIC_IMMUTABLE_X_URL}/v1/collections/${process.env.NEXT_PUBLIC_IMX_PIRATES_COLLECTION}/filters`;

const PiratesFilters: React.FC = (): JSX.Element => {
