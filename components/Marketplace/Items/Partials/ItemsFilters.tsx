...
const URL = `${process.env.NEXT_PUBLIC_IMMUTABLE_X_URL}/v1/collections/${process.env.NEXT_PUBLIC_IMX_ITEMS_COLLECTION}/filters`;

const ItemsFilters: React.FC = (): JSX.Element => {
