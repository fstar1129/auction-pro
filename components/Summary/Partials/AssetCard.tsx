...
import { setAssetsSelected, setSelected } from "../../../state/user/userSlice";
interface IAssets {
...
const AssetsCard: React.FC<IAssets> = ({
  user,
  assetName,
  assetType,
  assetImage,
        ...
        <div className="text-white text-center m-1 mx-auto flex flex-col items-center w-full min-w-[275px] gap-2">
          <div className="flex justify-center items-center">
            <img
              src={assetImage}
              alt={assetName}
              className="h-[125px] p-3 cursor-pointer"
              onClick={() => {
                dispatch(setSelected(assetName.toLocaleLowerCase()));
                dispatch(setAssetsSelected("summary"));
              }}
            />
