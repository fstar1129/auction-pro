...
const PirateSellDialog: React.FC = (): JSX.Element => {
  const dispatch = useAppDispatch();
  const dialog = useAppSelector(selectDialog);
  const user = useAppSelector(selectUser);
  const [price, setPrice] = useState<number>(0);
  const [usdPrice, setUsdPrice] = useState<number>(0);
  const [buttonText, setButtonText] = useState<string>("SELL PIRATE");
  ...
  const sellPirate = async () => {
    ...
    if (price > 0) {
      ...
      try {
        ...
        dispatch(closeDialog());
        showWarning(
          "Selling pirate: " + pirate?.metadata?.name + " was aborted."
        );
      }
    } else {
      showError("Please enter a price for your pirate!");
    }
  };
          ...
          <div className="bg-[#11131c] h-[325px] flex">
            ...
            <div className="w-full h-full flex justify-center items-center flex-col gap-2">
              ...
              <div className="relative inline-block text-left" ref={ref}>
                ...
                <div className="absolute right-0 z-30 mt-2 w-[150px] rounded-md bg-elementor-text-2">
                  <div
              ...
              {selected !== "Select currency" && (
                <>
                  ...
                  <button
                    ...
                    onClick={
                      !isConnectedToImx ? connectWalletToImx : sellPirate
                    }
                  >
...
export default PirateSellDialog;
